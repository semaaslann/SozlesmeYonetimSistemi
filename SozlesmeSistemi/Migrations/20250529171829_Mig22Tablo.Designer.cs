...
namespace SozlesmeSistemi.Migrations
{
    ...
    [Migration("20250529171829_Mig22Tablo")]
    partial class Mig22Tablo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SozlesmeSistemi.Models.Contract", b =>
                {
                    ...
                    b.Property<int?>("ImzalayanKisiId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SozlesmeSistemi.Models.Contract", b =>
                {
                    ...
                    b.HasOne("SozlesmeSistemi.Models.User", "ImzalayanKisi")
                        .WithMany()
                        .HasForeignKey("ImzalayanKisiId")
                        .OnDelete(DeleteBehavior.Restrict);
