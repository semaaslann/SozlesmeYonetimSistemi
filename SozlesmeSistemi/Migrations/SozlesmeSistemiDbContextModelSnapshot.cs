...
namespace SozlesmeSistemi.Migrations
{
    ...
    partial class SozlesmeSistemiDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SozlesmeSistemi.Models.ContractParaf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ParafTarihi")
                        .HasColumnType("datetime2");

                    b.Property<int>("ParaflayanUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParaflayanUserId");

                    b.ToTable("ContractParafs");
                });
            ...
            modelBuilder.Entity("SozlesmeSistemi.Models.ContractParaf", b =>
                {
                    b.HasOne("SozlesmeSistemi.Models.Contract", "Contract")
                        .WithMany("ContractParafs")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SozlesmeSistemi.Models.User", "ParaflayanUser")
                        .WithMany()
                        .HasForeignKey("ParaflayanUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Contract");

                    b.Navigation("ParaflayanUser");
                });
